import { FaPlus, FaFileUpload, FaDownload, FaCheckCircle, FaTimesCircle } from 'react-icons/fa';
...
export default function DamageTypesHeader({
  totalCount,
  activeCount,
  inactiveCount,
  filterStatus,
  ...
  return (
    <PageHeader
      statsCounters={[
        { icon: <GiCrossedSwords />, value: totalCount, label: 'Total' },
